...
return $settings = array(
     ...
     */
    //'logoutRoute' => env('SAML2_TEST_REDIRECT_URL', 'https://portfoliodeinovacao.icict.fiocruz.br/'). 'login',
    'logoutRoute' => '/',
    /**
     * Where to redirect after login if no other option was provided
     */
    //'loginRoute' => env('SAML2_TEST_REDIRECT_URL', 'https://portfoliodeinovacao.icict.fiocruz.br/'),
    'loginRoute' => '/',
     ...
     * If commented out, defaults to this lib's controller (MrBrownNL\Saml2\Http\Controllers\Saml2Controller).
     ...
     */
     // 'saml2_controller' => '',
    'saml2_controller'  =>  'App\Http\Controllers\LoginController',
